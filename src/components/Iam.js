    ...
    return (
        ...
        <Container>
            <section style={{ paddingBottom: '100px', paddingTop: '100px', paddingLeft: '5px', paddingRight: '5px' }}>
                ...
                <Row style={{ padding: '0', }}>
                    <Col sm={8}>
                        <p style={{ textAlign: 'left', }}>I am <span style={{ color: '#7f3398', fontWeight: 'bolder' }}>Mohan Krishna Kattamuri</span>. I'm a MERN stack developer, UI/UX designer, a BlockChain Enthusiast and Problem solving Enthusiast as well.</p>
