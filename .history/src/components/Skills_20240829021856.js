...
import fb from "../assets/softwares/fb.png"
import native from "../assets/softwares/native.png"
import ang from "../assets/softwares/ang.png"
import api from "../assets/softwares/api.png"
import py from "../assets/softwares/py.png"
import ts from "../assets/softwares/ts.png"
            ...
            <div className="skill-bx wow zoomIn">
              ...
              >
                {[
                  ...
                  { src: native, label: 'React-Native' },
                  { src: ang, label: 'Angular' },
                  { src: ts, label: 'TypeScript' },
                  { src: py, label: 'Python' },
                  { src: api, label: 'Fast API' },
